...
export const geminiService = {
  ...
  async suggestSmartTaxBreakdown(productName: string, totalPrice: number, profile: FiscalProfile): Promise<any> {
  ...
  async validateFiscalData(productName: string, ncm: string, category: string): Promise<any> {
  ...
  async analyzeBusinessHealth(data: any): Promise<string> { return "OK."; },
  async analyzeNcm(ncm: string): Promise<any> { return { text: "NCM OK" }; },
  async suggestReplenishment(i: any): Promise<any> { return "OK"; },
  async analyzeSectors(s: any): Promise<any> { return "OK"; },
  async suggestLabelStandards(a: any, b: any): Promise<any> { return "OK"; },
  async suggestSmartTax(n: string): Promise<any> { return null; }
};
